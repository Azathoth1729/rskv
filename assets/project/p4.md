...
- [PNA Rust Project 4: Concurrency and parallelism](#pna-rust-project-4-concurrency-and-parallelism)
  - [Introduction](#introduction)
  - [Project spec](#project-spec)
  - [Project setup](#project-setup)
  - [Background: blocking and multithreading](#background-blocking-and-multithreading)
  - [Part 1: Multithreading](#part-1-multithreading)
  - [Part 2: Creating a shared `KvsEngine`](#part-2-creating-a-shared-kvsengine)
  - [Part 3: Adding multithreading to `KvServer`](#part-3-adding-multithreading-to-kvserver)
  - [Part 4: Creating a real thread pool](#part-4-creating-a-real-thread-pool)
    - [So how do you build a thread pool?](#so-how-do-you-build-a-thread-pool)
  - [Part 5: Abstracted thread pools](#part-5-abstracted-thread-pools)
  - [Part 6: Evaluating your thread pool](#part-6-evaluating-your-thread-pool)
    - [Ok, now to the first two benchmarks](#ok-now-to-the-first-two-benchmarks)
  - [Part 7: Evaluating other thread pools and engines](#part-7-evaluating-other-thread-pools-and-engines)
    - [Extension 1: Comparing functions](#extension-1-comparing-functions)
    - [Background: The limits of locks](#background-the-limits-of-locks)
  - [Part 8: Lock-free readers](#part-8-lock-free-readers)
    - [Explaining our example data structure](#explaining-our-example-data-structure)
    - [Strategies for breaking up locks](#strategies-for-breaking-up-locks)
      - [Understand and maintain sequential consistency](#understand-and-maintain-sequential-consistency)
      - [Identify immutable values](#identify-immutable-values)
      - [Duplicate values instead of sharing](#duplicate-values-instead-of-sharing)
      - [Break up data structures by role](#break-up-data-structures-by-role)
      - [Use specialized concurrent data structures](#use-specialized-concurrent-data-structures)
      - [Postpone cleanup until later](#postpone-cleanup-until-later)
      - [Share flags and counters with atomics](#share-flags-and-counters-with-atomics)
    - [Implement lock-free readers](#implement-lock-free-readers)
